...
func ui_show_pre_level_debug_config_choice(initial_friendly_troops: int, boss_head_hit_points: int, conquered_friendly_troops: int, campaign_enemy_troop_increase_per_level: int, friendly_march_bonus_troops: int) -> void:
	if _main == null or _main.ui == null:
		return
	if _main.ui.has_method("show_pre_level_debug_config_choice"):
		_main.ui.call("show_pre_level_debug_config_choice", initial_friendly_troops, boss_head_hit_points, conquered_friendly_troops, campaign_enemy_troop_increase_per_level, friendly_march_bonus_troops)
...
func _on_pre_level_debug_config_confirmed(initial_friendly_troops: int, boss_head_hit_points: int, conquered_friendly_troops: int, campaign_enemy_troop_increase_per_level: int, friendly_march_bonus_troops: int) -> void:
	...
	if _main.has_method("_on_pre_level_debug_config_confirmed"):
		_main.call("_on_pre_level_debug_config_confirmed", initial_friendly_troops, boss_head_hit_points, conquered_friendly_troops, campaign_enemy_troop_increase_per_level, friendly_march_bonus_troops)
