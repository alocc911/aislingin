...
const PROVINCE_COUNTS_BACKGROUND_Z_INDEX := LevelConfig.VISUAL_LAYER_DISPLAY_WINDOWS
const PROVINCE_COUNTS_LABEL_Z_INDEX := LevelConfig.VISUAL_LAYER_DISPLAY_WINDOWS + 1
	...
	match province_type:
		...
		LevelConfig.PROVINCE_TYPE_FRIENDLY:
			return {
				...
				"remaining_troops": LevelConfig.get_initial_province_troops(LevelConfig.PROVINCE_TYPE_FRIENDLY),
				"faction_id": 0,
				"construction_progress": 0
			}
		_:
	...
	match province_type:
		...
		LevelConfig.PROVINCE_TYPE_FRIENDLY:
			counts = {
				...
				"remaining_troops": LevelConfig.get_conquered_province_troops(LevelConfig.PROVINCE_TYPE_FRIENDLY),
				"faction_id": 0,
				"construction_progress": 0
			}
		_:
